...
public class TaskDefectsTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		testTask1 = CurrentProject.getTaskList().createTask(startDate, endDate, "testTitle1", 1, 5, 1, "testDesc1", null);
		testTask2 = CurrentProject.getTaskList().createTask(startDate, endDate, "testTitle2", 2, 10, 2, "testDesc2", null);
