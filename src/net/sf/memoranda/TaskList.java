...
public interface TaskList {
    ...
    Task createTask(CalendarDate startDate, CalendarDate endDate, String text, int priority, long effort, long actEffort, String description, String parentTaskId);
