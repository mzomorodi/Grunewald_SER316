...
public class EstimatedEffortTest {
	...
	public void setUp() throws Exception {
		...
		test1 = CurrentProject.getTaskList().createTask(sd, ed, "GSD", 2, (long)4.0, (long)1.5, 2, 365, "The Stuff to Get Done", null, null);
		test2 = CurrentProject.getTaskList().createTask(sd, ed, "GSDN", 2, (long)4.0, (long)4.0, 2, 365, "The Stuff to Get Done Now", null, null);
	}
