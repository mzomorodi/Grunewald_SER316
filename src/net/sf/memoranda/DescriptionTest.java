...
public class DescriptionTest {
	...
	public void setUp() throws Exception {
		...
		desTest1 = CurrentProject.getTaskList().createTask(sd, ed, "GSD", 2, (long)4.0, (long)1.5, 2, 365, "The Stuff to Get Done", null, null);
		desTest2 = CurrentProject.getTaskList().createTask(sd, ed, "GSD", 2, (long)4.0, (long)1.5, 2, 365, null, null, null);
	}
